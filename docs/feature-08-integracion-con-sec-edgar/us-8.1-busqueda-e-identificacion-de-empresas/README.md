# User Story 8.1 - Búsqueda e identificación de empresas
...
**Quiero** buscar empresas en SEC EDGAR por nombre o ticker y obtener su CIK

**Para** acceder a información financiera oficial desde los endpoints correctos.
...
5. Dado un ticker válido, cuando se consulta el CIK, entonces el sistema devuelve el CIK correcto.
